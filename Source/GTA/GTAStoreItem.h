...
/// </summary>
	...
	void UpdateStoreItem(FPrimaryAssetId& id, float price, int32 maxCount, int32 currentCount, FText& description, FSlateBrush icon);
...
/// </summary>
	UPROPERTY(EditAnyWhere, BlueprintReadOnly, Category = "StoreItem")
	static TMap<FPrimaryAssetId, UGTAStoreItem *> m_StoreMap;
};
